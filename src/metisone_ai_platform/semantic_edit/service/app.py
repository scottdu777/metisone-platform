...
from metisone_ai_platform.semantic_edit.cube_yaml.repository import CubeYamlDocument
from metisone_ai_platform.semantic_edit.service.chat_agent import (
    RuleBasedSemanticEditAgent,
)
from metisone_ai_platform.semantic_edit.service.config import (
    EditServiceConfig,
    load_config_from_env,
)
from metisone_ai_platform.semantic_edit.service.schemas import (
    ChatRequest,
    ChatResponse,
    AutoCompleteRequest,
    CompileResponse,
...
def create_app(
    config: EditServiceConfig | None = None,
    ...
    install_json_request_logging(
        app,
        service_name="semantic_edit_yaml_service",
        paths=("/v1/",),
